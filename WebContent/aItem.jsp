...
<% ArrayList<String> array=(ArrayList<String>)session.getAttribute("currentItem"); %>
	
<div id="itemImage" class="row justify-content-center">
    <img style="width:256px;height:256px;" src="<%= array.get(2)%>">
</div>
<div class="row justify-content-center">
    <p id="itemBrand">Brand : <% out.print(array.get(0)); %></p>
</div>
<div class="row justify-content-center">
    <p id="itemName">Name : <% out.print(array.get(1));%></p>
</div>
<div class="row justify-content-center">
    <p id="itemPrice">Price : <% out.print(array.get(3));%></p>
</div>
<div class="row justify-content-center">
    <p id="itemStock">Stock : <% out.print(array.get(4));%></p>
</div>
<div class="row justify-content-center">
<form action="/{{model}}" method="POST">
</form>
     <button id="addToCartButton" type="button" class="btn btn-dark">
        <a class="text-light" href="/WebProgFinal/addToCart/<%=array.get(0)%>">
            Add to Cart
        </a>
    </button>
</div>
