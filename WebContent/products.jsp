...
<table class="table">
  ...
  <tbody>
	...
	<% ArrayList<String[]> array=(ArrayList<String[]>)session.getAttribute("allItems");%>
	<%! int i; %>
	...
	<%for(i=0;i<array.size();i++){%>
      ...
      <td ><% out.print(model[3]);%></td>
      <td><button class="btn btn-dark"><a class="text-light" href="/WebProgFinal/aItem/<%= model[0] %>">Show Details</a></button></td>
    </tr>
    <%} %>
